...
public class TimelineActivity extends AppCompatActivity {
    ...
    private void composeMessage() {
        Intent appInfo = new Intent(TimelineActivity.this, ComposeActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == RESULT_CODE) {
            //unwrapped parcel object
            Tweet object = Parcels.unwrap(data.getParcelableExtra(Tweet.class.getSimpleName()));

            //adds tweet at top of timeline
            tweets.add(0, object);
